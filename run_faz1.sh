#!/bin/bash
# =============================================================================
# run_faz1.sh — Auto-generated by generate_massive_topology.py  [phase=1]
# =============================================================================
# Toplam config : 84
# Run/config    : 36  (sensorSF 7..12 × meshSF 7..12)
# Toplam run    : 3024
# Phase         : 1  (Baseline: sigma=0, gamma=2.75, ideal kanal)
#
# Kullanım:
#   bash run_faz1.sh [--jobs N] [--from-config IDX] [--to-config IDX]
#   bash run_faz1.sh --config Faz1_GW2_Mesh1_MIN  # tek config
#   bash run_faz1.sh --jobs 4 --from-config 0 --to-config 9  # ilk 10 config
#
# Resume: .done flag'leri sayesinde kaldığı yerden devam eder.
#   Silmek için: rm -rf logs_faz1/<ConfigName>
# =============================================================================
...
echo "SCA dosyaları: ${PROJ_DIR}/results_faz1/Faz1_*.sca"
