#!/bin/bash
# =============================================================================
# run_full144.sh — Arazi1_Faz2_Full144 Batch Runner (144 Run)
# =============================================================================
# Kullanım: bash run_full144.sh [--jobs N] [--from RUN] [--to RUN]
...
# Örnek: bash run_full144.sh --jobs 4
# =============================================================================
...
# ── Konfigürasyonun kaç run ürettiğini doğrula ───────────────────────────────
echo "=== Arazi1_Faz2_Full144 Batch Runner ==="
echo "Config   : ${CONFIG}"
...
run_one() {
    ...
    if [[ ${exit_code} -eq 0 ]]; then
        touch "${done_flag}"
        # Kilit mekanizması ile counter güncelle
        (
            flock -x 200
...
echo ""
echo "Analiz için:"
echo "  python3 ${PROJ_DIR}/analyze_full144.py"
