#!/bin/bash
# =============================================================================
# run_faz4.sh — Auto-generated by generate_massive_topology.py  [phase=4]
# =============================================================================
# Toplam config : 84
# Run/config    : 36  (sensorSF 7..12 × meshSF 7..12)
# Toplam run    : 3024
# Phase         : 4  (sigma=5.0, gamma=2.8, obstacle=3.5dB, noiseFloor=-105dBm, sendInterval=180s (BTK/KET YasalSinir))
#
# Kullanım:
#   bash run_faz4.sh [--jobs N] [--from-config IDX] [--to-config IDX]
#   bash run_faz4.sh --config Faz4_GW2_Mesh1_MIN  # tek config
#   bash run_faz4.sh --jobs 4 --from-config 0 --to-config 9  # ilk 10 config
#
# Resume: .done flag'leri sayesinde kaldığı yerden devam eder.
#   Silmek için: rm -rf logs_massive_faz4/<ConfigName>
# =============================================================================
...
RUNS_PER_CONFIG=36
LOG_BASE="${PROJ_DIR}/logs_massive_faz4"
...
echo "SCA dosyaları: ${PROJ_DIR}/results_faz4/Faz4_*.sca"
