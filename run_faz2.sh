#!/bin/bash
# =============================================================================
# run_faz2.sh — Auto-generated by generate_massive_topology.py  [phase=2]
# =============================================================================
# Toplam config : 84
# Run/config    : 36  (sensorSF 7..12 × meshSF 7..12)
# Toplam run    : 3024
# Phase         : 2  (sigma=6.0, gamma=3.5, obstacle=7dB (beton), sendInterval=180s (BTK/KET GlobalMax))
#
# Kullanım:
#   bash run_faz2.sh [--jobs N] [--from-config IDX] [--to-config IDX]
#   bash run_faz2.sh --config Faz2_GW2_Mesh1_MIN  # tek config
#   bash run_faz2.sh --jobs 4 --from-config 0 --to-config 9  # ilk 10 config
#
# Resume: .done flag'leri sayesinde kaldığı yerden devam eder.
#   Silmek için: rm -rf logs_massive_faz2/<ConfigName>
# =============================================================================
...
RUNS_PER_CONFIG=36
LOG_BASE="${PROJ_DIR}/logs_massive_faz2"
...
echo "SCA dosyaları: ${PROJ_DIR}/results_faz2/Faz2_*.sca"
