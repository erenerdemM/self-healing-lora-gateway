#!/bin/bash
# =============================================================================
# run_faz3.sh — Auto-generated by generate_massive_topology.py  [phase=3]
# =============================================================================
# Toplam config : 84
...
#   bash run_faz3.sh --config Faz3_GW2_Mesh1_MIN  # tek config
#   bash run_faz3.sh --jobs 4 --from-config 0 --to-config 9  # ilk 10 config
#
# Resume: .done flag'leri sayesinde kaldığı yerden devam eder.
#   Silmek için: rm -rf logs_massive_faz3/<ConfigName>
# =============================================================================
...
RUNS_PER_CONFIG=36
LOG_BASE="${PROJ_DIR}/logs_massive_faz3"
...
echo "SCA dosyaları: ${PROJ_DIR}/results_faz3/Faz3_*.sca"
